...
func main() {
	...
	fmt.Println("Started building core/presets/configs.go")

	configs, err := os.Create("core/presets/configs.go")
	...
	fmt.Println("Finished building core/presets/configs.go")
}
